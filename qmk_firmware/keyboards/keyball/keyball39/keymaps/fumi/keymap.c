...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [3] = LAYOUT_universal(
    ...
    _______  , T(KC_X)  , T(KC_C)  , T(KC_V)  , _______  ,                            _______  , _______  , _______  , _______  , _______  ,
  ...
  [7] = LAYOUT_universal(
    ...
    _______  , T(KC_X)  , T(KC_C)  , T(KC_V)  , _______  ,                            _______  , MS_BTN3  , MS_BTN4  , KC_PGDN  , _______  ,
